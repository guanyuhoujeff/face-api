...
class UTKfaceAgeTorchDetector(ModelHandler):
    def __init__(self, 
...
class UTKfaceAgeOpenvinoDetector(ModelHandler):
    def __init__(self, model_path = 'face_age_resnet18.xml', device=None) -> None:
        super().__init__()
